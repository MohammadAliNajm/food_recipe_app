...
//  final performanceInterceptor = DioFirebasePerformanceInterceptor();
  ...
  Future<WebServiceResponse?> get(
    ...
    try {
      ...
      _logger.info(tag, 'Headers:  $headers');
      _logger.info(tag, 'Query: $queryParams');
...
//            };
        ...
        _logger.error(tag, '$e  , POST:   $url', StackTrace.current);
